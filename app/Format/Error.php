...
class Error{
    protected $error = [
        ...
        61454=>'客服帐号名长度超过限制 ( 仅允许 10个英文字符，不包括@及@后的公众号的微信号 )(invalid kf_acount length)',
        ...
        65313=>'不合法的省份信息',
        65314=>'不合法的城市信息',
        65316=>'该公众号的菜单设置了过多的域名外跳（最多跳转到 3个域名的链接）',
        65317=>'不合法的 URL',
    ...
    //错误信息改为中文
    protected function get($errCode){
//        if(!is_array($data) || !array_key_exists('errcode',$data)){
//            return $data;
//        }
        if (isset($this->error[$errCode])) {
            return ['errcode' => $errCode, 'errmsg' => $this->error[$errCode]];
        }
